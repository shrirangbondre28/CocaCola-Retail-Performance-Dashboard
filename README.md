# CocaCola-Retail-Performance-Dashboard
This Excel-based dashboard provides a dynamic analysis of Coca-Cola’s key American retailers, focusing on beverage sales performance and operating margins. Built using PivotTables, interactive slicers, and KPI indicators, the dashboard allows users to explore sales trends, retailer performance, and profitability insights in real time.

## Table of Contents
- [Business Context and Key Question](#business-context-and-key-question)
- [Analytical Approach](#analytical-approach)
- [Key Insights and Recommendations](#key-insights-and-recommendations)
- [Business Impact and Tools](#business-impact-and-tools)
...
- Defined key business metrics: revenue, profit, profit margin, and unit economics
- Segmented analysis across:
     - Geography (region-wise performance)
     - Product categories (volume vs profitability trade-offs)
     - Time (trend and seasonality patterns)
- Applied a Pareto-based lens (80/20 analysis) to identify concentration risks and opportunities
- Built an interactive Excel dashboard to enable dynamic slicing of performance drivers
